...
| # | Point | Échéance |
|---|---|---|
| 1 | **La passe de ton sur les ~80 textes de la spécification.** Ils ont été rédigés avant que le registre d'écriture soit arrêté. C'est **tout ou rien** : réécrire trois textes sur quatre-vingts produirait un corpus incohérent d'une autre manière. L'encadré en tête de `02-specification-ux.md` porte les trois garde-fous | **Avant que les clés i18n existent** |
...
| 7 | **Le sous-ensemble Phosphor n'est pas embarqué.** Les icônes du §1.8 viennent du paquet `phosphor_flutter`, publié pour la dernière fois en mai 2024. Un sous-ensemble embarqué — police ou SVG — rendrait l'inventaire incassable quelle que soit la suite du paquet | Post-MVP |
